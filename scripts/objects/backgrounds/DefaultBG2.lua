...
function BG:drawBack()
	...
	for x = -100, 740, 50 do
		for y = -100, 580, 50 do
			candlebg = Assets.getTexture("bg/defaultbg2")
			love.graphics.draw(candlebg, x + self.offset/2, y + self.offset/2 + 10)
		end
	end
end
...
function BG:drawFront()
	...
	for x = 0, 740, 50 do
		for y = 0, 580, 50 do
			candlebg = Assets.getTexture("bg/defaultbg2")
			love.graphics.draw(candlebg, x - self.offset, y - self.offset)
		end
	end
end
