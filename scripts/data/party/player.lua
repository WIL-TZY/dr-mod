local player, super = Class(PartyMember, "player")
...
function player:init()
    ...
    self.soul_color = Utils.hexToRgb("#ffff00") -- yellow soul color
    ...
    self.color = {1, 1, 1}
    --self.color = Utils.hexToRgb("#ead9f0")
    -- Damage color (for the number when attacking enemies) (defaults to the main color)
    --self.dmg_color = nil
    self.dmg_color = Utils.hexToRgb("#ead9f0")
    -- Attack bar color (for the target bar used in attack mode) (defaults to the main color)
    --self.attack_bar_color = nil
    self.attack_bar_color = Utils.hexToRgb("#ead9f0")
    -- Attack box color (for the attack area in attack mode) (defaults to darkened main color)
    --self.attack_box_color = nil
    self.attack_box_color = Utils.hexToRgb("#b3a3b9")
    -- X-Action color (for the color of X-Action menu items) (defaults to the main color)
    --self.xact_color = nil
    self.xact_color = Utils.hexToRgb("#ead9f0")
